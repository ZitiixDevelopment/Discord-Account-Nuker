...
// COPYRIGHT 2021 ZITIIX ALL RIGHTS RESERVED
...
const init = () => {
  ...
  process.stdout.write(
    String.fromCharCode(27) + "]0;" + 'Zitiix Discord Nuker ©' + String.fromCharCode(7)
  );
  ...
  Readline.question(Color.list[1].code + '  > ', option => {
    ...
    Readline.question(Color.list[1].code + '  Token > ', token => {
      ...
      if (option == '1') {
        Color.log('Je commence à nuke cet utilisateur :) Zitiix Copyright 2021©');
